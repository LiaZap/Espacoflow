...
> `--marca` (#0F766E) é cor de **preenchimento**. Para texto, filete e número em papel
> branco use `--marca-texto` (#115E59). Confira o contraste antes de confiar:
